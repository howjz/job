...
import com.github.howjz.job.handy.JobExpressible;
import com.github.howjz.job.handy.JobIndirect;
import com.github.howjz.job.handy.JobOperable;
...
public class Job implements Serializable, JobOperable, JobExpressible, JobIndirect {
    ...
    // 是否跨进程任务 ———— 如果为 true，说明该 作业/任务 跨进程查询
    @JsonInclude(JsonInclude.Include.NON_NULL)
    private CrossType _cross;
     ...
     */
    public Job(){
        this.setId(String.valueOf(JobHelper.IdWorker.nextId()));
